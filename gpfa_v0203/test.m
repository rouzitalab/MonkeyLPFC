...
analysisBlock=[2 2]; %[1 8];%4 or 7 is all ; these are groups of analysis Periods
%analysisGroup=[];
...
analysisGroup{1}.aPeriods=[ 12];%106 % always put lower number here (its a bug)
analysisGroup{1}.trialIntervals = [0 300]; 
analysisGroup{2}.aPeriods=[16];  %these are in analysis Periods
analysisGroup{2}.trialIntervals = [1000 1300];

excludeNoiseUnits = 1;
% ops.K=2;  %# of allowable clusters
% filename =  'sra3_2_j_039_00+02.resmat' %'sra3_2_j_039_00+01.resmat'%'
...
model2 = curve_clusting_fixedM(Trajs,ops,model); %
