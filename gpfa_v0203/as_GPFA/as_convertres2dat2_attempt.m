function dat1=as_convertres2dat2_attempt(filename,analysisBlock,excludeNoiseUnits,analysisGroup)
...
% turned off
% _attempt by ajs in Oct 2012 to recreate the old version for exp 1
if nargin<4
    analysisGroup=[];
end
