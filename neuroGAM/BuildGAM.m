function [models, x, nvars] = BuildGAM(xt,yt,prs)
...
models.wtsMat = models.wtsMat';
%% match weights 'wts' to corresponding inputs 'x'
models.wts = cellfun(@(x,y) {x,1,cell2mat(nprs).*y},models.wts,models.class,'UniformOutput',false);
models.wtsMat = cellfun(@(x,y) {x,nfolds,cell2mat(nprs).*y},models.wtsMat,models.class,'UniformOutput',false);
models.basis = basis; 
