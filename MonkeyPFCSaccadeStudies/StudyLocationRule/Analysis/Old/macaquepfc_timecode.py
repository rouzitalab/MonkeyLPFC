...
#     importer = ImportH5(filename=os.path.join(data_root, sess_name, sess_name + '.h5'))
#     patch = Graph()
#     patch.chain(importer,
#                 ExtractStreams(stream_names=["analogsignals", "spiketrains", "segmented-markers"]),
#                 MultitaperCoherence(half_bandwidth=5, ref_stream_name="analogsignals"),
#                 ExtractStreams(stream_names=["spiketrains", "segmented-markers"]),
#                 ConditionalMean(),
#                 ExportH5(filename=os.path.join(data_root, sess_name, sess_name + '_spklfpcoh.h5')))
