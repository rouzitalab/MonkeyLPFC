function [models, rate, yt_sim] = BuildGAM(xt,yt,prs)
...
sacwts = cell2mat(models.wts{1}(~strcmp(xname,'spikehist')));
colwts = cell2mat(models.wts{2}(~strcmp(xname,'spikehist')));
rulwts = cell2mat(models.wts{3}(~strcmp(xname,'spikehist')));
rate = invlinkfunc(cell2mat(x(~strcmp(xname,'spikehist')))*[sacwts, colwts, rulwts]')/dt;
...
spikehist = models.gainfactors{1}{1}.mean;
